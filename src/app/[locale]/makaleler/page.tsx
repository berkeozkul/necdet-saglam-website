...
export async function generateMetadata() {
  ...
  return {
    title: `${t("blog")} | Prof. Dr. Necdet Sağlam`,
    ...
    <div className="flex flex-col min-h-screen">
      ...
      <section className="bg-primary py-20 text-white relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 md:px-6 relative z-10 text-center">
          <h1 className="font-heading text-4xl md:text-5xl font-bold mb-4">{c("articles")}</h1>
          ...
          <p className="text-xl text-white/80 max-w-2xl mx-auto">
            {locale === 'tr' 
              ...
              : 'The latest developments, treatment methods, and healthy living guide in the field of orthopedics and traumatology.'}
          </p>
        </div>
      </section>
          ...
          {!posts || posts.length === 0 ? (
            <div className="text-center py-20">
              ...
              <h2 className="text-2xl font-bold text-primary mb-2">
                {locale === 'tr' ? 'Henüz Makale Bulunmuyor' : 'No Articles Found'}
              </h2>
              <p className="text-foreground/60">
                {locale === 'tr' ? 'Çok yakında yeni yazılarımızla karşınızda olacağız.' : 'We will be here with new articles very soon.'}
              </p>
            </div>
          ) : (
